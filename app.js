...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //when a data is added
    ref.child("projectId1234").child("Doing").on("child_added", function (snap) {
        //console.log(snap.key(), snap.val());
        var notFound = true;
    ...
    //when a data is removed
    ref.child("projectId1234").child("Doing").on("child_removed", function (snap) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //when a data is added
    ref.child("projectId1234").child("Review").on("child_added", function (snap) {
        //console.log(snap.key(), snap.val());
        var notFound = true;
    ...
    //when a data is removed
    ref.child("projectId1234").child("Review").on("child_removed", function (snap) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //when a data is added
    ref.child("projectId1234").child("Done").on("child_added", function (snap) {
        //console.log(snap.key(), snap.val());
        var notFound = true;
    ...
    //when a data is removed
    ref.child("projectId1234").child("Done").on("child_removed", function (snap) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $scope.add = function (newTaskObject, state) {
        ...
        ref.child("projectId1234").child(state).child(newTaskObject.key).set(newTaskObject.value);
        $scope.newTask = "";
    };

    //remove a task from firebase "not from local array"
    $scope.delete = function (key, state) {
        ref.child("projectId1234").child(state).child(key).set(null);
    };
